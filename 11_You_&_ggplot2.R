...
'If you havent already installed and loaded the `ggplot2` package, you will need to do that before you can use the `ggplot()` function. 
...
When you start to explore the data, it doesnt show what you would expect. That is why you decide to create a visualization to see how true that statement is-- or isnt.
...
The plot reveals that your stakeholders hypothesis is incorrect. You report back to your stakeholder that many of the advanced bookings are being made by people with 0 children.'
...
What did you discover? Is your stakeholder correct?
  ...
  Remember, if you are having trouble filling out a code block, check the solutions document for this activity.'
