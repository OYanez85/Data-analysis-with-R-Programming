...
In this activity, you will review a scenario, and continue to apply your knowledge of data visualization with ggplot2. You will learn more about the aesthetic features of visualizations and how to customize them by specific criteria. 
...
This code chunk creates three bar charts for 'no_deposit', 'non_refund', and 'refundable' deposit types. You notice that its hard to read the x-axis labels here, so you add one piece of code at the end that rotates the text to 45 degrees to make it easier to read. 
